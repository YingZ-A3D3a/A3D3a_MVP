...
def set_initial_to_zero(dir0,save_dir,topN = 60,
          ...
          ct_types = ['BLCA','BRCA',
            'COADREAD','KIRC',
            'LUAD',
            'PRAD','THCA','UCEC']):  # 't_names': tumor types in oncoKB, 'ct_types':corresponding TCGA types
    ...
    ### add target genes curated from cansar.ai
    tumor_types = ['BLCA','BRCA','COADREAD','KIRC','LUAD','PRAD','THCA','UCEC']
    types_in_cansar = ['Bladder Cancer','Breast Cancer','Bowel Cancer',
                    'Kidney Cancer','NSCLC Cancer','Prostate Cancer','Thyroid Cancer','Endometrial Cancer']
    ...
    plt.xticks([i for i in np.arange(0,350,50)],fontsize = 6)
